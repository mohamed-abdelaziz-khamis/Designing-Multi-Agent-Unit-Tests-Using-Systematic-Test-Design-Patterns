...
public class BookingClientAgentTestCase extends JADETestCase {
	...
	public static Test suite() {
		return new TestSuite(BookingClientAgentTestCase.class);
	}	
	...
	public void testBooking(){
		...
		AgentController clientAgent = createAgent("client",
			"PairPatterns.BookingPattern.BookingClientAgent.BookingClientAgent", args, myContainer); 		
