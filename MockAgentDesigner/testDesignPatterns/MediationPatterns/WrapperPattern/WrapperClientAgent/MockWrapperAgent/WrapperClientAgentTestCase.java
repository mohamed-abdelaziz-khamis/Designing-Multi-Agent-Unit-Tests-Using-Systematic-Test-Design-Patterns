...
public class WrapperClientAgentTestCase extends JADETestCase {
	...
	public static Test suite() {
		return new TestSuite(WrapperClientAgentTestCase.class);
	}	
	...
	public void testWrapping(){	
		...
		args = new Object[2];
		args[0] =  getResourceString("Message_Content");		
		args[1] =  getResourceString("Language");
		
		AgentController clientAgent = createAgent("client",
			"MediationPatterns.WrapperPattern.WrapperClientAgent.WrapperClientAgent",
			args, myContainer);	
		...
		AgentController mockWrapperAgent = createAgent("wrapper",
			"MediationPatterns.WrapperPattern.WrapperClientAgent.MockWrapperAgent.MockWrapperAgent", args, myContainer); 		
