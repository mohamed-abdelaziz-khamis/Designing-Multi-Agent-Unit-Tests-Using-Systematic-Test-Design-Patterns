...
public class ForeignAgentTestCase extends JADETestCase {
	...
	public static Test suite() {
		return new TestSuite(ForeignAgentTestCase.class);
	}	
	...
	public void testForeign(){	
		...
		AgentController foreignAgent = createAgent("foreign",
			"MediationPatterns.EmbassyPattern.ForeignAgent.ForeignAgent",
			args, myContainer);	
		...
		AgentController mockEmbassyAgent = createAgent("embassy",
			"MediationPatterns.EmbassyPattern.ForeignAgent.MockEmbassyAgent.MockEmbassyAgent", args, myContainer); 		
